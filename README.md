...
This is the code accompanying the paper "Expressive power of tensor-network factorizations for probabilistic modeling with applications from hidden Markov models to quantum machine learning" and allowing to reproduce its numerical results. If you use this code or these results please cite [1].
